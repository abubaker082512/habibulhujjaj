...
const Footer = () => {
  const [footerContent, setFooterContent] = useState({
    description: 'Habibulhujaj Umrah & Travels specializes in crafting meaningful spiritual journeys and world-class international tours for the discerning traveler.',
