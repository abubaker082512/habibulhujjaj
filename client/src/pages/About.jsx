      ...
      <main>
            ...
            <h1 className="font-notoSerif text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-white leading-tight mb-6">
              {cmsContent.heroTitle.includes('Us') ? (
                <>
                  ...
                  <span className="text-[#013334]">Us</span>
        ...
        <section className="py-16 md:py-24 px-4 sm:px-6 md:px-8 lg:px-24 bg-surface-container-low">
          <div className="max-w-screen-2xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-center">
            <div className="relative">
              <div className="absolute -top-6 -left-6 md:-top-10 md:-left-10 w-24 h-24 md:w-32 md:h-32 lg:w-40 lg:h-40 border-l-2 border-t-2 border-[#013334]/30"></div>
              ...
              <div className="absolute -bottom-6 -right-6 bg-[#013334] p-8 hidden md:block z-20">
          ...
          <div className="max-w-screen-2xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              ...
              <div className="md:col-span-7 bg-primary-container p-6 md:p-10 lg:p-12 flex flex-col justify-center relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-64 h-64 bg-[#013334]/5 rounded-full -mr-32 -mt-32 transition-transform duration-700 group-hover:scale-110"></div>
                <span className="font-manrope tracking-widest uppercase text-xs text-[#013334] mb-4">Our Mission</span>
              ...
              {/* Vision */}
              <div className="md:col-span-5 bg-surface-container-high p-6 md:p-10 lg:p-12 flex flex-col justify-center border-b-4 border-[#013334]">
        ...
        <section className="py-16 md:py-24 px-4 sm:px-6 md:px-8 lg:px-24 bg-surface-container-low relative">
          <div className="text-center mb-12 md:mb-16">
            <h6 className="font-manrope text-[#013334] font-bold text-sm tracking-[0.2em] uppercase mb-4">What We Stand For</h6>
            <h2 className="font-notoSerif text-3xl sm:text-4xl lg:text-5xl text-primary mb-4">Core Principles</h2>
            <div className="w-24 h-1 bg-[#013334] mx-auto opacity-50"></div>
          </div>
        ...
        <section className="py-16 md:py-24 bg-primary-container relative overflow-hidden">
          ...
          <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
            <div className="text-center mb-12 md:mb-16">
              <h6 className="font-manrope text-[#013334] font-bold text-sm tracking-[0.2em] uppercase mb-4">Our Journey</h6>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
              {[
                ...
                <div key={i} className="text-center">
                  <div className="font-notoSerif text-3xl md:text-4xl lg:text-5xl font-bold text-[#013334] mb-2">{stat.number}</div>
